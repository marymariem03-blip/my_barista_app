...
const List<Branch> kBranches = [
  Branch(id: 'branch_01', name: "Barista's Menzah 9",
      address: 'El Menzah', plusCode: 'R5X4+4G Tunis',
      lat: 36.8436, lng: 10.1935,
      image: 'assets/images/branches/branch_01.jpg'),
  Branch(id: 'branch_02', name: "Barista's Menzah 6",
      address: 'El Menzah 6', plusCode: 'R5XC+97 Ariana',
      lat: 36.8502, lng: 10.1888,
      image: 'assets/images/branches/branch_02.jpg'),
  Branch(id: 'branch_03', name: "Barista's Centre Urbain Nord",
      address: 'Centre Urbain Nord', plusCode: 'R5XW+397, Tunis',
      lat: 36.8611, lng: 10.1947,
      image: 'assets/images/branches/branch_03.jpg'),
  Branch(id: 'branch_04', name: "Barista's Les Berges du Lac",
      address: 'Lac, Tunis', plusCode: 'R6MR+WG Tunis',
      lat: 36.8320, lng: 10.2283,
      image: 'assets/images/branches/branch_04.jpg'),
  Branch(id: 'branch_05', name: "Barista's Staroil Mohamed 5",
      address: 'Ave Mohamed V', plusCode: 'R58M+3MQ, Tunis',
      lat: 36.8065, lng: 10.1815,
      image: 'assets/images/branches/branch_05.jpg'),
  Branch(id: 'branch_06', name: "Barista's Ariana",
      address: 'Ariana', plusCode: 'V53P+PM Ariana',
      lat: 36.8625, lng: 10.1956,
      image: 'assets/images/branches/branch_06.jpg'),
  Branch(id: 'branch_07', name: "Barista's La Marsa",
      address: 'La Marsa', plusCode: 'V8HM+P6G',
      lat: 36.8781, lng: 10.3247,
      image: 'assets/images/branches/branch_07.jpg'),
  Branch(id: 'branch_08', name: "Barista's Les Jardins de Carthage",
      address: 'Tunis', plusCode: 'V75X+5R Tunis',
      lat: 36.8601, lng: 10.3198,
      image: 'assets/images/branches/branch_08.jpg'),
  Branch(id: 'branch_09', name: "Barista's Lac 2",
      address: 'Avenue De La Bourse', plusCode: 'R7XC+89J, Tunis',
      lat: 36.8412, lng: 10.2401,
      image: 'assets/images/branches/branch_09.jpg'),
  Branch(id: 'branch_10', name: "Barista's Sousse",
      address: 'Avenue Taieb Mhiri', plusCode: 'RJQG+XRX, Sousse',
      lat: 35.8256, lng: 10.6369,
      image: 'assets/images/branches/branch_10.jpg'),
  Branch(id: 'branch_11', name: "Barista's Bardo",
      address: 'Tunis', plusCode: 'R47V+2Q Tunis',
      lat: 36.8094, lng: 10.1444,
      image: 'assets/images/branches/branch_11.jpg'),
  Branch(id: 'branch_12', name: "Barista's Pathé Tunis City",
      address: 'Cebalat Ben Ammar', plusCode: 'V4XF+8W',
      lat: 36.9012, lng: 10.2156,
      image: 'assets/images/branches/branch_12.jpg'),
  Branch(id: 'branch_13', name: "Barista's Pathé Azur City",
      address: 'Ben Arous', plusCode: 'P7G5+82',
      lat: 36.7312, lng: 10.2289,
      image: 'assets/images/branches/branch_13.jpg'),
  Branch(id: 'branch_14', name: "Barista's Mall of Sfax",
      address: 'Route de Tunis Km 10', plusCode: 'Sakiet Ezzit',
      lat: 34.7893, lng: 10.7601,
      image: 'assets/images/branches/branch_14.jpg'),
  Branch(id: 'branch_15', name: "Barista's L'Aouina",
      address: 'Tunis', plusCode: 'V754+697 Tunis',
...
final List<Product> _products = [
  const Product(
    id: 'prod_01', name: 'Frappuccino Caramel',
    category: 'drink', price: 11.500,
    image: 'assets/images/frappuccino.png',
    isBestSeller: true,
  ),
  const Product(
    id: 'prod_02', name: 'Iced Macchiato Caramel',
    category: 'drink', price: 9.500,
    image: 'assets/images/iced_macchiato.png',
    isBestSeller: true,
  ),
  const Product(
    id: 'prod_03', name: 'Macchiato Caramel',
    category: 'drink', price: 8.500,
    image: 'assets/images/macchiato.png',
    isBestSeller: true,
  ),
  const Product(
    id: 'prod_04', name: 'Cachuète',
    category: 'food', price: 10.500,
    image: 'assets/images/cachuete.png',
    isBestSeller: true,
  ),
  const Product(
    id: 'prod_05', name: 'Mexican Salad',
    category: 'food', price: 10.000,
    image: 'assets/images/salade_cesar.png',
  ),
  const Product(
    id: 'prod_06', name: 'Frappuccino Praliné Pistache',
    category: 'drink', price: 15.500,
    image: 'assets/images/frappuccino.png',
  ),
  const Product(
    id: 'prod_07', name: 'Red Velvet',
    category: 'food', price: 10.500,
    image: 'assets/images/cachuete.png',
  ),
  const Product(
    id: 'prod_08', name: 'Strawberry Matcha',
    category: 'drink', price: 14.000,
    image: 'assets/images/macchiato.png',
  ),
];
